...
// http://den2sn.hatenablog.com/entry/2014/03/07/224928
...
function authenticate(helper, paramsValues, credentials) {
    ...
    requestBody = paramsValues.get("Group field")          + "=" + encodeURIComponent(credentials.getParam("Group"));
...
function getRequiredParamsNames(){
    return ["Target URL", "Group field", "Username field", "Password field"];
}
